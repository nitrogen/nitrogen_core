...
- `diagram_options` (`{DiagramType, Options}` tuple) - DiagramType can be
  `sequence`, `flowchat`, `gantt`. And Options is a list of Mermaid diagram
  options using a standard Erlang proplists (a list of 2-tuples, like `{Option, Value}`.

### See Also

- [base element](./element_base.md)
- [Demo: Mermaid Flowcharts and Diagrams](http://nitrogenproject.com/demos/demos_mermaid1)
- [Demo: Mermaid with Postbacks](http://nitrogenproject.com/demos/demos_mermaid2)
- [Demo: Mermaid Async Updates](http://nitrogenproject.com/demos/demos_mermaid3)
