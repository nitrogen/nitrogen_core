...
** Attributes
   ...
   + blocks - (/List of #mobile\_grid\_block{}/) :: Set the list of mobile blocks. To skip to end a row early and skip down to the next row, set the #mobile\_grid\_block{}'s new\_row attribute to 'true'. Elements defined after a 'new\_row' element will continue from that  block in a normal fashion.
...
** See Also
   ...
   + [[./mobile_grid_block.html][mobile\ grid\_block element]]
