...
** Creating your plugin from scratch
   ...
   3) Place any static resources in the =priv= directory in the root of the
      plugin and call that directory =static=. So =priv/static= is where your
      static resources should go.
