...
-record(recaptcha, {?ELEMENT_BASE(element_recaptcha), captcha_opts=[], button_id, button_label="Check!", delegate, tag, fail_body="Please try again!", public_key, private_key, challenge_url, verify_url}).
...
-record(confirm_same, {?VALIDATOR_BASE(validator_confirm_same), confirm_id}).
