...
-record(hidden, {?ELEMENT_BASE(element_hidden), text="", html_encode=true, html_name}).
...
-record(mobile_toggle, {?ELEMENT_BASE(element_mobile_toggle), data_fields=[], on_text="On", on_value="on", off_text="Off", off_value="off", selected="on", postback, delegate, theme=""}).
...
-record(mobile_grid_block, {?ELEMENT_BASE(element_grid_block), data_fields=[], text="", body=[], new_row=default}).
